...
{
    /**
     * @Route("/organization/{id}", name="organization", defaults={ "id"="" })
     */
    public function organization(Request $request, $id)
    {
        ...
        $form = $this->createFormBuilder($organization)
            ...
            ->add('function', TextType::class, [ 'required' => false, 'label' => 'Relatie', 'attr' => [ 'placeholder' => 'Bv. bruikleennemer, koerier, externe firma, ...' ]])
            ...
            ->add('notes', TextareaType::class, [ 'required' => false, 'label' => 'Notities', 'attr' => [ 'placeholder' => 'Eigen notities over deze persoon of organisatie' ]])
