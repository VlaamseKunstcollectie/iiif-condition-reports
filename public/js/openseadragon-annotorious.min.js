...
var OSDAnnotationLayer_OSDAnnotationLayer = /*#__PURE__*/function (_EventEmitter) {
  ...
  function OSDAnnotationLayer(_props) {
    var _this;
    ...
    _this.viewer = _props.viewer;
    _this.readOnly = _props.config.readOnly;
    _this.headless = _props.config.headless;
    _this.formatter = _props.config.formatter;
    ...
    _this.selectedShape = null;
    _this.tools = new ToolsRegistry_ToolRegistry(_this.g, _props.config, _props.env);
