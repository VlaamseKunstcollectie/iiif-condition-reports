...
var OSDAnnotationLayer_OSDAnnotationLayer = /*#__PURE__*/function (_EventEmitter) {
  ...
  function OSDAnnotationLayer(props) {
    ...
    OSDAnnotationLayer_defineProperty(OSDAnnotationLayer_assertThisInitialized(_this), "setDrawingEnabled", function (enable) {
      ...
      (_this$mouseTracker = _this.mouseTracker) === null || _this$mouseTracker === void 0 ? void 0 : _this$mouseTracker.setTracking(enable);

      if (enable) {
        for (var i = 0; i < _this.drawingEnabledEvents.length; i++) {
          window[_this.drawingEnabledEvents[i]]();
        }
      } else {
        for (var i = 0; i < _this.drawingDisabledEvents.length; i++) {
          window[_this.drawingDisabledEvents[i]]();
        }
      }
    });
    ...
    _this.drawingEnabledEvents = [];
    _this.drawingDisabledEvents = [];
